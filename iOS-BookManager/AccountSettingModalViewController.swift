...
class AccountSettingModalViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        setAccountSettingModalViewLayout()
...
extension AccountSettingModalViewController {
    func setAccountSettingModalViewLayout() {
        // アドレスと入力フォーム類の位置設定
